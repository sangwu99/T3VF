...
from mantis_vla_utils import MantisVLA, MantisVLATTTOOD
...
def eval_libero(cfg: GenerateConfig) -> None:
    ...
    # OOD: use task_suite_name for action un-normalization
    cfg.unnorm_key = cfg.task_suite_name

    # Load model
    if cfg.ttt_enabled:
        mantis_vla = MantisVLATTTOOD(
            cfg.model_id,
            cfg.checkpoints_dir,
            cfg.norm_file_path,
            ttt_lr=cfg.ttt_lr,
    ...
    rollout_dir = f"./experiments/rollouts_ood/{folder_name}"
